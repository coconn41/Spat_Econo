...
model2.1=lm(data = KingsCountyHomeSales_1_,
          formula = log(price) ~ as.factor(zipcode) + pop_estimate +
...
resid=base::subset(model3.2$residuals,model3.2$residuals < -1)
ind=1
